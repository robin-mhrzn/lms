import { CheckCircle, Search } from "lucide-react"; // Importing lucide-react icons
          ...
          <div className="col-span-6 flex flex-col gap-8 ">
            ...
            <div className="relative rounded-full pt-5 lg:pt-0">
              <input
                type="Email address"
                name="q"
                className="py-6 lg:py-8 pl-8 pr-20 text-lg w-full text-black rounded-full focus:outline-none shadow-input shadow-input-shadow"
